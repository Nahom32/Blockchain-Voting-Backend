...
import { generalElectionByOrganizationUpdate,syncElectionDatabase } from '@application/statistics/statistics.db.contract';
...
const taskInterval = cron.schedule('*/1 * * * *', syncElectionDatabase);
